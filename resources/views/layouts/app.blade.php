...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-dark my_shadow">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <div class="dropdown-menu dropdown-menu-right my_shadow bg-dark" aria-labelledby="navbarDropdown">
